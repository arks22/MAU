...
def configs():
    ...
    parser.add_argument('--total_length', type=int, default=100)
    ...
    parser.add_argument('--dataset', type=str, default='a1a211')
    ...
    parser.add_argument('--perforamnce_dir', type=str, default='results/a1a211/')
    parser.add_argument('--save_dir', type=str, default='')
    parser.add_argument('--gen_frm_dir', type=str, default='results/a1a211/')
