...
def configs():
    ...
    parser.add_argument('--dataset',                type=str,   default='aia211')
    parser.add_argument('--config',                 type=str,   default='')
    parser.add_argument('--is_training',            type=str,   default='True')
    parser.add_argument('--data_train_path',        type=str,   default='data/aia211_1/train/aia211_train_512.npy')
    parser.add_argument('--data_test_path',         type=str,   default='data/aia211_1/test/aia211_test_512.npy')
    parser.add_argument('--data_val_path',          type=str,   default='data/aia211_1/val/aia211_val_512.npy')
    ...
    #parser.add_argument('--perforamnce_dir',        type=str,   default='results/aia211/')
    parser.add_argument('--save_dir',               type=str,   default='models/aia211')
    parser.add_argument('--gen_frm_dir',            type=str,   default='results/aia211/')
