...
def configs(args):
    ...
    if args.lr                     == None : args.lr                      = 5e-5
    if args.lr_decay               == None : args.lr_decay                = 0.95
    #if args.delay_interval         == None : args.delay_interval          = 100000
    if args.delay_interval         == None : args.delay_interval          = 225 #evry epoch
    ...
    if args.sampling_stop_iter     == None : args.sampling_stop_iter      = 225 #30epoch以降
