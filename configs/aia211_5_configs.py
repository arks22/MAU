...
def configs():
    ...
    parser.add_argument('--data_train_path',        type=str,   default='data/aia211_5/train/aia211_train.npy')
    parser.add_argument('--data_val_path',          type=str,   default='data/aia211_5/val/aia211_val.npy')
    parser.add_argument('--data_test_path',         type=str,   default='data/aia211_5/test/aia211_test.npy')
